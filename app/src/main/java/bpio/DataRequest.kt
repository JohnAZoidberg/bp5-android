...
class DataRequest : Table() {
    ...
    companion object {
        ...
        fun addStartMain(
            builder: FlatBufferBuilder,
            startMain: Boolean,
        ) = builder.addBoolean(0, startMain, false)

        fun addStartAlt(
            builder: FlatBufferBuilder,
            startAlt: Boolean,
        ) = builder.addBoolean(1, startAlt, false)

        fun addDataWrite(
            builder: FlatBufferBuilder,
            dataWrite: Int,
        ) = builder.addOffset(2, dataWrite, 0)

        @kotlin.ExperimentalUnsignedTypes
        fun createDataWriteVector(
            builder: FlatBufferBuilder,
            data: UByteArray,
        ): Int {
        ...
        fun addBytesRead(
            builder: FlatBufferBuilder,
            bytesRead: UShort,
        ) = builder.addShort(3, bytesRead.toShort(), 0)

        fun addStopMain(
            builder: FlatBufferBuilder,
            stopMain: Boolean,
        ) = builder.addBoolean(4, stopMain, false)

        fun addStopAlt(
            builder: FlatBufferBuilder,
            stopAlt: Boolean,
        ) = builder.addBoolean(5, stopAlt, false)
